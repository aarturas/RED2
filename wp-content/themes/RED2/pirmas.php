         ...
         <div class="row">
            <div class="col-lg-12">
               ...
               <nav class="nav-collapse">
                  <ul>
                     <li class="menu-item active"><a href="{{route('home')}}" img src="{{asset('figma3.html')}}" data-scroll>Home</li>
                     <li class="menu-item"><a href="{{route('about_us')}}" img src="{{asset('about.html')}}" data-scroll>About Us</a></li>
                     <li class="menu-item"><a href="{{route('social')}}" img src="{{asset('social.html')}}" data-scroll>Social</a></li>
