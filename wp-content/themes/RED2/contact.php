...
<div style="background-color:blue; padding-top:10px;" font-style="color:white;">
   ...
   <p style="color:azure; padding:20px;">
      ...
      we cooperate with Australian and foreign companies, <br>
      we communicate directly with our consumers. <br>
   </p>

   <a href="<?= get_permalink(get_page_by_path('p-c', OBJECT, 'page')) ?>">
      <img class="img" src="https://cdn.pixabay.com/photo/2015/05/06/16/31/andromeda-galaxy-755442_960_720.jpg"
         alt="andromeda" style="padding-top:50px; max-width:100%; padding-bottom:0px; ">
   </a>
