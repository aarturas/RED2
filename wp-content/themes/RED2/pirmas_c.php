...
<!-------------------------------------------------------------------------------------------  -->
<!--                          PHP kodo pradžia  /  GET - HEADER                                -->
<!-------------------------------------------------------------------------------------------  -->

<?php get_header();   ?>

<!-------------------------------------------------------------------------------------------  -->
<!--                          PHP kodo pabaiga  /  GET - HEADER                                -->
<!-------------------------------------------------------------------------------------------  -->
...
<!-- --------------------------------------------------------------------------------------------- -->
<!--                   SEKCIJA / "SHOWCASE" / su užrašu:   UŽRAŠAS "MEET OUR TEAM"                 -->
<!-- --------------------------------------------------------------------------------------------- -->
      ...
      <div class="row box-images">
         ...
         <div class="col-lg-3 col-sm-12 col-md-6 box">
            <div>
               ...
               <!-- --------------------------------------------------------------------------------------------- -->
               <!--                        Įdedame PHP kodą, su funkcija FOR EACH (loopas)                        -->
               <!-- --------------------------------------------------------------------------------------------- -->
      ...
      <div class="swiper-container">
         <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
               ...
               </div> <!-- -------".showcase2-card" - pabaiga ----- -->
            </div> <!-- -------".swiper-slide" - pabaiga ----- -->
...
<!-- ------------------------------------------------------------------------------------------------------ -->
<!--                Trečia dalis su: / SHOWCASE-3 / ir su EMAIL'u, žemėlapiu ir t.t.                        -->
<!-- ------------------------------------------------------------------------------------------------------ -->
...
<section class="showcase3">
   ...
   <div class="row">
      ...
      <div class="showcase3-card">
         ...
         </div> <!-- ---- ".mapouter", arba žemėlapio - pabaiga --- -->
