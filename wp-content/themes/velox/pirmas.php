   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-12">
            ...
            ?> alt=""/></a></div> -->
            <div class="logo"><a href="#"><img src="<?= get_field('pirmas_slaidas')?>" alt=""/></a></div>   
...
<section id="services">
   <div class="container">
      <div class="row">
         <div class="col-lg-12">
            <h2 class="os-animation" data-os-animation="zoomIn" data-os-animation-delay="0.3s"><?= get_field('servisai') ?></h2>
