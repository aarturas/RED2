...
add_action('wp_enqueue_scripts', function () {
   ...
   wp_enqueue_style( 'grid', get_theme_file_uri('css/grid.css'), [], VER_);
   wp_enqueue_style( 'style', get_theme_file_uri('style.css'), [], VER_);
...
add_action('wp_footer', function () {
   ...
   wp_enqueue_script( 'mixitup', get_theme_file_uri('js/jquery.mixitup.min.js'), [], VER_);
	wp_enqueue_script( 'bxslider', get_theme_file_uri('js/jquery.bxslider.js'), [], VER_);
